function playerdropshead:image/set_image_data {\
  width: 8,\
  height: 8,\
  image_data: [\
  ...
  description: [\
    "Player Drops Head",\
    {text: "Players drop their head when killed by another player", color: "#aaaaaa"},\
    "",\
    [{text: "Datapack version: ", color: "#00a800"}, {text: "v3.4.1", color: "#54fc54"}],\
